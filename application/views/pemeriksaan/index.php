...
<body><div class="container rounded">
    <div id="sectionform" class="section forma">
        ...
        <form id="form1" action="<?=base_url();?>pemeriksaan/tambahpemeriksaan" method="POST">
            ...
            <?php elseif( $this->session->flashdata('errpemeriksaan')):?>
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <?= $this->session->flashdata('errpemeriksaan');?>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="form-row">
                    <div class="col">
                        ...
                        <input type="hidden" id="fidPeriksa" name="idPeriksa">
                            ...
                            <div class="col form-group row"><label class="col-form-label col-sm-4">Panduan OAT</label><select class="form-control col-sm-4 dis" id="fpanduanoat" name="panduanoat"><option value="" selected="">-</option><option value="FDC">FDC</option><option value="Lepasan">Lepasan</option></select>
                                <input class="form-control col-sm-4 dis dis" type="text" id="fnoat" name="noat"></div>
                    ...
                    <div style="padding:3px 8px;">
                        ...
                        <div class="border border-primary rounded-bottom border-top-0">
                            ...
                            <div class="col form-group row"><label class="col-form-label col-sm-4">DM</label><select class="form-control col-sm-4 dis" id="fdm" name="dm"><option value="" selected="">-</option><option value="Ya">Ya</option><option value="Tidak">Tidak</option></select></div>
                        <div class="col form-group row"><label class="col-form-label col-sm-4">Pengobatan DM</label><select class="form-control col-sm-4 dis" id="fpengobatandm" name="pengobatandm"><option value="" selected="">-</option><option value="Ya">Ya</option><option value="Tidak">Tidak</option></select></div>
                </div>
            </div>
            <div style="padding:3px 8px;">
                <div class="col-form-label col-sm-5 border-bottom-0 border border-primary rounded-top border-right-0" style="height:40px;padding:2px 16px;">
                ...
                <div class="border border-primary rounded-bottom border-top-0">
                    <div class="col form-group row"><label class="col-form-label col-sm-4">Tempat</label><select class="form-control col-sm-4 dis" id="fstokoat" name="stokoat"><option value="" selected="">-</option><option value="RS">RS</option><option value="PKM">PKM</option></select>
                        <input class="form-control col-sm-4 dis" type="text" id="fntempatoat" name="ntempatoat"></div>
                </div>
            </div>
            <div style="padding:3px 8px;">
                ...
                <div class="border border-primary rounded-bottom border-top-0">
                    <div class="col form-group row"><label class="col-form-label col-sm-4"></label><select class="form-control col-sm-4 dis" id="flanjutoat" name="lanjutoat"><option value="" selected="">-</option><option value="RS">RS</option><option value="PKM">PKM</option></select>
                        <input class="form-control col-sm-4 dis" type="text" id="fntempatloat" name="ntempatloat"></div>
                </div>
            </div>
    </div>
    <div class="col">
        ...
        <div class="border border-primary rounded-bottom border-top-0">
            <div class="col form-group row"><label class="col-form-label col-sm-4">Mikroskopis</label><select class="form-control col-sm-4 dis" id="fmikkonv" name="mikkonv"><option value="" selected="">-</option><option value="Konvresi">Konversi</option><option value="Non Konversi">Non Konversi</option></select>
                <input class="form-control col-sm-4 dis" type="text" id="fnilaikonv" name="nilaikonv"></div>
    ...
    <div style="margin:8px 0px;">
       ...
       <div class="border border-primary rounded-bottom border-top-0">
            ...
            <div class="col form-group row"><label class="col-form-label col-sm-4">Waktu Periksa</label><input class="form-control col-sm-5 dis" type="date" id="ftcmtgl" name="tcmtgl">
            <!-- <input class="form-control col-sm-3 dis" type="time" id="ftcmwkt" name="tcmwkt"> -->
            </div>
            <!-- <div class="col form-group row"> -->
                <!-- <label class="col-form-label col-sm-4">Ruang</label><select class="form-control col-sm-4 dis" id="fruang" name="ruang"><option value="" selected="">-</option><option value="Rawat Jalan">Rawat Jalan</option><option value="Rawat Inap">Rawat Inap</option><option value="RSF">RSF</option></select> -->
                <!-- <select
    ...
    <!-- <div
        ...
        <div style="margin:0px 0px;margin-top:6px;">
            ...
            <div class="border border-primary rounded-bottom border-top-0">
                ...
                <div class="col form-group row"><label class="col-form-label col-sm-4">Tanggal Berhenti</label><input class="form-control col-sm-6 dis" type="date" id="ftglhenti" name="tglhenti"></div>
        </div>
        </div>
        <div style="margin:0px 0px;margin-top:6px;">
            <div class="col-form-label col-sm-7 border-bottom-0 border border-primary rounded-top border-right-0" style="height:40px;padding:2px 16px;">
		...
		<div class="buttonsub">
		<button class="btn kiri hid buttoncolor" type="button">Bersihkan</button>
		<button id="tubah" class="btn kiri buttoncolor" type="button">Ubah</button>
		<button class="btn kanan buttoncolor" type="submit">Tambah Data</button>
		</div>
        </form></div>
 ...
 <!-- <div> TABEL -->
<div class="tablediv">
        <div class="form-group pull-right round">
        ...
        <table class="table table-striped table-hover results">
            <thead>
                <tr>
                    ...
                    <th scope="colgroup"><span></span></th>
                    <th scope="colgroup"><span></span></th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td> 
                            <button href=".forma" type="button" class="btn linkdetil buttoncolor" data-id="<?= $p['idPeriksa'];?>">
                            Detil
                            </button>
                    </td>
                    <td>
