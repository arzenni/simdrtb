        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> 
                            <button type="button" class="btn btn-primary detilperiksa" onclick="<?php echo base_url();?>pemeriksaan/detil/<?= $p['idPeriksa']; ?>">
                            Detil
                            </button>
                    </td>
                    <td><button type="button" class="btn btn-primary modaledit" >
                    edit
                    </button></td>
                </tr>
                <?php endforeach; ?>
